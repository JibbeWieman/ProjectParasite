...
public class ActorWeaponsManager : MonoBehaviour
{
    ...
    public CinemachineFreeLook WeaponCamera;
    ...
    readonly WeaponController[] m_WeaponSlots = new WeaponController[9]; // 9 available weapon slots
    protected PlayerInputHandler m_InputHandler;
    protected ActorCharacterController m_ActorCharacterController;
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandler, ActorWeaponsManager>(m_InputHandler, this,
            gameObject);

        m_ActorCharacterController = GetComponent<ActorCharacterController>();
        DebugUtility.HandleErrorIfNullGetComponent<ActorCharacterController, ActorWeaponsManager>(
            m_ActorCharacterController, this, gameObject);
    ...
    {
        m_ActorCharacterController.ActorCamera.fieldOfView = fov;
    ...
    {
        if (m_WeaponSwitchState == WeaponSwitchState.Up && GetComponent<Actor>().IsActive())
        {
            WeaponController activeWeapon = GetActiveWeapon();
